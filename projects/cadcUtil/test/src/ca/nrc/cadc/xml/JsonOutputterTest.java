...
public class JsonOutputterTest
{
    ...
    @Test
    public void writeNamespaceIfAvailable() throws Exception
    {
        final JsonOutputter testSubject = new JsonOutputter();
        final Element itemsElement = new Element("items");

        itemsElement.addNamespaceDeclaration(
                Namespace.getNamespace("itemns", "http://ns.items.com"));
        ...
        final JSONObject expected = new JSONObject("{\r\n"
                                                   + "\"items\" : {\r\n"
                                                   + "  \"item\": ["
                                                   + "  {\"$\" : \"0\", \"@xmlns\": {\"itemns\":\"http://ns.items.com\"}},\r\n"
                                                   + "  {\"$\" : \"1\", \"@xmlns\": {\"itemns\":\"http://ns.items.com\"}},\r\n"
                                                   + "  {\"$\" : \"2\", \"@xmlns\": {\"itemns\":\"http://ns.items.com\"}},\r\n"
                                                   + "  {\"$\" : \"3\", \"@xmlns\": {\"itemns\":\"http://ns.items.com\"}},\r\n"
                                                   + "  {\"$\" : \"4\", \"@xmlns\": {\"itemns\":\"http://ns.items.com\"}}\r\n"
                                                   + "],\"@xmlns\": {\"itemns\":\"http://ns.items.com\"}}}");
        final JSONObject result = new JSONObject(writer.toString());
