...
/**
 * The default Format object returned by the base FormatFactory. This class can
 * correctly output null, String, URI, and URL. For all other object types, it
 * will call the toString() method. Overriding the toString method <em>is not</em>
