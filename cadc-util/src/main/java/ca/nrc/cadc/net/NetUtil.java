...
public class NetUtil {
    ...
    /**
     * @param conn      HTTP URL Connection to read from.
     * @param dest      The stream to write to.
     * @throws IOException      For any reading or writing errors.
     * @deprecated
     */
    ...
    /**
     * Obtain the IP address of the request source.  This will check for the header called 'X-Forwarded-For' first, then
     * look for the getRemoteAddr() value from the request.
     *
